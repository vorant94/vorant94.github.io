...
![example project ui](./example-project-ui.png)
...
![example project schema](./example-project-schema.png)
...
![lambdas file structure and javascript code](./lambdas-file-structure-and-javascript-code.png)
...
![lambdas file structure and typescript code](./lambdas-file-structure-and-typescript-code.png)
...
![build output of lambda with multiple root dirs](./build-output-of-lambda-with-multiple-root-dirs.png)

![lambda handler change in cloud formation template](./lambda-handler-change-in-cloud-formation-template.png)
...
![multi-target codegen](./multi-target-codegen.png)
