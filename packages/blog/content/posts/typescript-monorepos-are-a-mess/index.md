...
![TypeScript meme](./typescript-meme.webp)
...
![TypeScript meme](./monorepo-meme.webp)
...
![nodemon and ts-node logos with tsc logo in the background](./nodemon+ts-node.webp)
...
![tsx imaginary logo with esbuild in the backgound](./tsx.webp)
...
![nodejs and typescript logo](./node+tsc.webp)
